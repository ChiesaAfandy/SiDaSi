...
<html>
    ...
    <body>
         <%
            ...
            modelKelas data = dao.getDataById(Integer.parseInt(id_kelas));
         %>
         <div class="formkelas">
            <h1>Form Input Data Guru</h1>
        <div class='row'>
            <div class='col-8'>     
            <form class="form" action="kelasServletEdit" method="GET">
                <input type="hidden" name="id_kelas" value="<%=id_kelas%>"/>
                <div class="form-group">
                  <label for="kelas"><b>Kelas</label>
                  <input type="text" class="form-control" value="<%=data.getKelas()%>" name="kelas">               
                </div>
                <div class="form-group">
                  <label for="walikelas">Wali Kelas</label>
                  <input type="text" class="form-control" value="<%=data.getWalikelas()%>" name="walikelas">
                </div>
